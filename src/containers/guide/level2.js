            ...
            <div className="card-content">
              ...
              <div className="">
                ...
                <ul className="prompts">
                  ...
                  <li><i className="fa fa-check green-text text-lighten-2"></i><span> Teach that item is pushed to array only if the predicate will return true</span></li>
                  <li><i className="fa fa-check green-text text-lighten-2"></i><span> Teach student how to walk step by step thru the function using pseudo code</span></li>
                  <li><i className="fa fa-check green-text text-lighten-2"></i><span> Help studdent to practice creating functions on the fly</span></li>
              ...
              <ul className="prompts">
                ...
                <li><i className="fa fa-check green-text text-lighten-2"></i><span> Filter should use each to iterate over collection</span></li>
                ...
                <li><i className="fa fa-check green-text text-lighten-2"></i><span> Filter should return new array with a values that are passing the predicate test</span></li>
              </ul>
            </div>
            <div className="code">
            ...
            <div className="card-content">
              ...
              <div className="">
                ...
                <ul className="prompts">
                  ...
                  <li><i className="fa fa-check green-text text-lighten-2"></i><span> Teach that startValue will be a Memo on the first iteration and it will get modified(Memo) by accumulator on every iteration </span></li>
                  <li><i className="fa fa-check green-text text-lighten-2"></i><span> Teach that startValue is the value that will be returned in the end as the final result </span></li>
              ...
              <ul className="prompts">
                ...
                <li><i className="fa fa-check green-text text-lighten-2"></i><span> Reduce should pass result of accumulator(MEMO, ITEM) to the MEMO on every invocation of accumulator</span></li>
                ...
                <li><i className="fa fa-check green-text text-lighten-2"></i><span> Reduce should use startValue as final result</span></li>
              </ul>
            </div>
            <div className="code">
              <h5><b>Boilerplate:</b></h5>
